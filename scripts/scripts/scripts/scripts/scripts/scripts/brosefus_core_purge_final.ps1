...
# Create Sentinel Task XML
$sentinelTaskPath = Join-Path $belPath "bel_monitor.ps1"
$sentinelTaskXml = @"
...
<Task version="1.4" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions Context="Author">
    <Exec>
      ...
      <Arguments>-ExecutionPolicy Bypass -File "$sentinelTaskPath"</Arguments>
    </Exec>
  </Actions>
</Task>
"@

$sentinelTaskXml | Out-File -FilePath (Join-Path $belPath "sentinel_task.xml") -Encoding utf8
...
$monitorScript = @"
# BEL-v2 Monitor
`$configPath = '$belPath\config.json'
`$vaultPath = '$vaultPath'
`$logPath = '$belPath\monitor.log'
...
$monitorScript | Out-File -FilePath $sentinelTaskPath -Encoding utf8
