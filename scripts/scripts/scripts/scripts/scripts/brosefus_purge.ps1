...
# Copy scripts
Copy-Item -Path "$PSScriptRoot\brosefus_monitor.ps1" -Destination $belPath -Force
Copy-Item -Path "$PSScriptRoot\brosefus_hook.ps1" -Destination $belPath -Force
...
<Task version="1.4" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions Context="Author">
    <Exec>
      ...
      <Arguments>-ExecutionPolicy Bypass -File "$belPath\brosefus_monitor.ps1"</Arguments>
    </Exec>
  </Actions>
</Task>
"@

$taskXml | Out-File -FilePath (Join-Path $belPath "sentinel_task.xml") -Encoding utf8
